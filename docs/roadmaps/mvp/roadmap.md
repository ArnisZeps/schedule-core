...
- [ ] **M5c - UI polish**: Replace ad-hoc Tailwind with shadcn/ui component system. Design tokens, layout primitives, form validation (RHF + zod), toast feedback, AlertDialog confirmations, skeleton loading states, consistent empty/error states. Goal: professional, sellable UI that future milestones build on.
