...
Stack: pnpm monorepo, Next.js App Router (`apps/web`, including API layer as Route Handlers), Neon serverless PostgreSQL (`packages/db`), Terraform infra.
