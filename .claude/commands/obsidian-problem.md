Save a problem or blocker to the Obsidian vault.

Arguments: $ARGUMENTS (the problem title)
...
3. Create a note with this structure:
   ...
   **Status:** Open
   ...
   ```
4. Save via curl PUT to: `Job/Projects/ScheduleCore/Problems/<title>.md`
